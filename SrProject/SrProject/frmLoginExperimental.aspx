        ...
        <div >
            ...
            <div class="container-fluid" style="border-style: solid; border-color: red; margin-top: 30px; position: fixed; top: 50%; left: 50%; width: 100%; transform: translate(-50%,-50%);">
                ...
                <div class="row" style="border-style: solid; border-color: purple;"><!--  background-color: #eee -->
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 form-login">
                        <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs" style="border-style: solid; border-color: blue; min-height: 300px;"></div><!-- for picture on left-->
                    
                        <div class="col-lg-6 col-md-6 col-sm-6" style="border-style: solid; border-color: orchid; min-height: 300px;">
